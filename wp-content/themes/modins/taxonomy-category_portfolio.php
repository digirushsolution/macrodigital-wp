 ...
 */
	...
	$columns_lg = modins_get_option('portfolio_columns_lg', '4');
	$columns_md = modins_get_option('portfolio_columns_md', '3');
	$columns_sm = modins_get_option('portfolio_columns_sm', '2');
	$columns_xs = modins_get_option('portfolio_columns_xs', '1');
