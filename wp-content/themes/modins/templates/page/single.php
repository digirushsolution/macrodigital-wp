...
if (metadata_exists('post', get_the_ID(), 'modins_disable_page_title')){
  $disable_page_title = get_post_meta(get_the_ID(), 'modins_disable_page_title', true);
}
if (metadata_exists('post', get_the_ID(), 'modins_page_full_width')){
  $full_width = get_post_meta(get_the_ID(), 'modins_page_full_width', true);
  if($full_width){
