 ...
 */
   ...
   $columns_lg = modins_get_option('product_columns_lg', $std_lg);
   $columns_md = modins_get_option('product_columns_md', $std_md);
   $columns_sm = modins_get_option('product_columns_sm', $std_sm);
   $columns_xs = modins_get_option('product_columns_xs', $std_xs);
?>
