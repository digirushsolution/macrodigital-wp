<?php
   ...
   <div <?php echo $this->get_render_attribute_string( 'block' ) ?>>
      ...
      <div class="box-content clearfix">
         ...
         <?php 
            if($settings['job_content']){ 
               echo '<div class="job-desc">';
                  echo trim($settings['job_content']);
               echo '</div>';   
            }
         ?>
         ...
         <?php
            if (!empty($settings['link']['url'])){
               echo '<div class="job-action">';
                  echo '<a class="btn-theme btn-small" ' . $this->get_render_attribute_string( 'link' ) . '>' . esc_html__('Apply Now', 'modins') . '</a>';
               echo '</div>';
            }
         ?>
