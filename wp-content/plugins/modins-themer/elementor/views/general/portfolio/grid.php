<?php
  ...
  $this->add_render_attribute('wrapper', 'class', ['gva-portfolio-grid clearfix', 'grid-' . $_random]);
      ...
      ?>
       <nav class="portfolio-filter">
          <ul class="nav nav-tabs">
             <li><a class="btn-filter all active" href="javascript:void(0)" data-filter="*"><span><?php echo esc_html__( 'All', 'modins-themer' ); ?></span><span class="count"></span></a></li>
             <?php 
