	...
	protected function register_controls() {
		  ...
		  $repeater->add_control(
				...
				[
					 ...
					 'default'    => [
						  'url' => GAVIAS_MODINS_PLUGIN_URL . 'elementor/assets/images/brand-1.png',
					 ],
		  ...
		  $this->add_control(
				'brands',
				[
					 'label'       => __('Brand Content Item', 'modins-themer'),
					 'type'        => Controls_Manager::REPEATER,
					 'fields'      => $repeater->get_controls(),
					 'title_field' => '{{{ title }}}',
					 'default'     => array(
						  array(
								'title'  => esc_html__( 'Brand 1', 'modins-themer' ),
								'image'  => array( 'url'	=> GAVIAS_MODINS_PLUGIN_URL . 'elementor/assets/images/brand.png' )
						  ),
						  array(
								'title'  => esc_html__( 'Brand 2', 'modins-themer' ),
								'image'  => array( 'url'	=> GAVIAS_MODINS_PLUGIN_URL . 'elementor/assets/images/brand.png' )
						  ),
						  array(
								'title'  => esc_html__( 'Brand 3', 'modins-themer' ),
								'image'  => array( 'url'	=> GAVIAS_MODINS_PLUGIN_URL . 'elementor/assets/images/brand.png' )
						  ),
						  array(
								'title'  => esc_html__( 'Brand 4', 'modins-themer' ),
								'image'  => array( 'url'	=> GAVIAS_MODINS_PLUGIN_URL . 'elementor/assets/images/brand.png' )
						  ),
						  array(
								'title'  => esc_html__( 'Brand 5', 'modins-themer' ),
								'image'  => array( 'url'	=> GAVIAS_MODINS_PLUGIN_URL . 'elementor/assets/images/brand.png' )
						  ),
						  array(
								'title'  => esc_html__( 'Brand 6', 'modins-themer' ),
								'image'  => array( 'url'	=> GAVIAS_MODINS_PLUGIN_URL . 'elementor/assets/images/brand.png' )
						  ),
					 ),
				]
		  ...
		  $this->add_control(
				...
				array(
					 ...
					 'default' => 'style-1',
					 'options' => [
						'style-1' => esc_html__('Style I', 'modins-themer'),
						'style-2' => esc_html__('Style II', 'modins-themer')
					 ]
				)
		  );
