<?php
   add_filter( 'elementor/icons_manager/additional_tabs', 'modins_custom_icons_filters' , 9999999, 1 );
   function modins_custom_icons_filters( $tabs = array() ) {
      $newicons = [
         "micon__folder",
         "micon__insurance",
         "micon__car",
         "micon__cardiogram",
         "micon__magnifying-glass",
         "micon__calling",
         "micon__healthy-life",
         "micon__car-1",
         "micon__home-insurance",
         "micon__save-money",
         "micon__online-registration",
         "micon__guarantee",
         "micon__medal",
         "micon__home1",
         "micon__cross",
         "micon__suitcase",
         "micon__fire1",
         "micon__wedding-rings",
         "micon__quote",
         "micon__group",
         "micon__life-insurance",
         "micon__success",
         "micon__right-arrow2",
         "micon__easy",
         "micon__controls",
         "micon__bonus",
         "micon__right-arrow-1",
         "micon__employees",
         "micon__self-service",
         "micon__meeting1",
         "micon__agreement1",
         "micon__family",
         "micon__phone-ringing",
         "micon__team",
         "micon__art",
         "micon__pdf",
         "micon__message",
         ...
         "flaticon-team-1",
         "flaticon-increment",
         "flaticon-increment-1",
         "flaticon-left-arrow",
         "flaticon-handshake",
         "flaticon-thumbs-up",
         "flaticon-thumbs-up-1",
         "flaticon-creativity",
         ...
         "flaticon-browser",
         "flaticon-web",
         "flaticon-crowdfunding",
         "flaticon-crowdfunding-1",
         "flaticon-crowdfunding-2",
         "flaticon-crowdfunding-3",
         "flaticon-fundraise",
         "flaticon-crowdfunding-4",
         "flaticon-chat",
      ...
      $icons['gva_custom_icon'] = array(
           'name'          => 'modins-icons-theme',
           'label'         => esc_html__( 'Icons Theme', 'modins-themer' ),
           'labelIcon'     => 'fas fa-user',
           'prefix'        => '',
           'displayPrefix' => '',
           'icons'         => $newicons,
           'url'          => GAVIAS_MODINS_PLUGIN_URL . 'assets/icons/style.css',
           'ver'           => '1.0',
       );
   ...
   add_action( 'wp_print_footer_scripts', 'modins_insert_icons_footer_css'  );
   function modins_insert_icons_footer_css() {
      echo '<link rel="stylesheet" type="text/css" href="' . GAVIAS_MODINS_PLUGIN_URL . 'assets/icons/style.css">';
   }

   add_filter( 'elementor/icons_manager/additional_tabs', 'modins_lineawesome_icon' );  
   function modins_lineawesome_icon( $icons = array() ) {
       ...
       $icons['modins-lineawesome-icon'] = array(
           'name'          => 'modins-icons-lineawesome',
           'label'         => esc_html__( 'Line Awesome', 'modins-themer' ),
           'labelIcon'     => 'fas fa-user',
           'prefix'        => '',
           'displayPrefix' => '',
           'icons'         => $lineawesome_icons,
            'url'          => GAVIAS_MODINS_PLUGIN_URL . 'elementor/assets/libs/line-awesome/css/line-awesome.min.css',
           'ver'           => '1.0',
       );
